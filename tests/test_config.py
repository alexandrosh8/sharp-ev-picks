...
def test_premium_adjustment_knobs_default_to_current_behavior() -> None:
    ...
    # The premium-adjustment knobs stay no-op; the only non-default values are
    # default-ON SELECTION GUARDS (not tunable knobs): the max_edge data-error
    # ceiling (0.20); the moneyline odds ceiling (4.0 — DEMOTES the CLV-negative
    # 1X2 longshot band to shadow; tightened from 5.0 by the 2026-07-07 diagnosis,
    # docs/research/2026-07-07-negative-clv-diagnosis.md); require_sharp_anchor
    # (True — a consensus-anchored premium candidate is demoted to shadow, since
