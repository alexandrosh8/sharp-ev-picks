"""GENERATED regression skeleton for the 2026-08-04 alias batch (review before
...
`uv run pytest tests/test_alias_batch_2026_08_04.py -q`."""
...
_BATCH: list[tuple[str, str, str]] = [
    ("AGF", "AGF Aarhus", "lech poznan"),
    ("Ballkani", "KF Ballkani", "bohemians"),
    ("Crawley", "Crawley Town", "york city"),
    ("Elgin", "Elgin City", "edinburgh city"),
    ("FCI Tallinn", "Levadia Tallinn", "ifk goteborg"),
    ("Levadia", "Levadia Tallinn", "siauliai"),
    ("Forfar", "Forfar Athletic", "kelty hearts"),
    ("Helsinki", "Helsingin Jalkapalloklubi", "coleraine"),
    ("Klaksvik", "KI Klaksvik", "fk kauno zalgiris"),
    # Operario-PR: warehouse feed variant of the SAME club (PR = Parana state
    # suffix of Operario Ferroviario EC, Ponta Grossa). The BARE 'Operario'
    # form stays out — golden _NOT_ADDED negative from the 2026-08-03 review.
    ("Operario-PR", "Operario Ferroviario", "atletico goianiense"),
    ("TNS", "The New Saints", "fc flora tallinn"),
]
